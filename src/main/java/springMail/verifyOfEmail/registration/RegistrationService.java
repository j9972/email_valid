...
import springMail.verifyOfEmail.appuser.AppUserRole;
import springMail.verifyOfEmail.appuser.AppUserService;
import springMail.verifyOfEmail.email.EmailSender;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        String link = "http://localhost:1111/api/v1/registration/confirm?token=" + token;
        emailSender.send(
                request.getEmail(),
